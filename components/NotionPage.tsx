...
export const NotionPage: React.FC<types.PageProps> = ({
  ...
  const router = useRouter(); // Next.js의 라우터 훅을 사용합니다.
  const lite = useSearchParam('lite'); // 'lite' 모드 여부를 확인합니다.
  ...
  return (
    <>
      ...
      <NotionRenderer
        ...
        showCollectionViewDropdown={false} // 컬렉션 뷰 드롭다운을 숨깁니다.
        ...
        searchNotion={config.isSearchEnabled ? searchNotion : null} // 검색 기능을 설정합니다.
